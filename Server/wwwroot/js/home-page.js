...
/***/ "./src/scripts/components/_contextMenu.ts":
/*!************************************************!*\
  !*** ./src/scripts/components/_contextMenu.ts ***!
  \************************************************/
/*! no static exports found */
...
function () {
  function ContextMenu() {
    this.checkboxGroup = jquery_1.default('.chkChonFile');
    this.init();
  }

  ContextMenu.prototype.init = function () {
    if (this.checkboxGroup) this.checkboxGroup.on('click', function () {
      var group = "input:checkbox[name='" + jquery_1.default(this).prop('name') + "']";
      jquery_1.default(group).not(this).prop('checked', false); // $(this).attr('checked', 'true');
    });
  };
...
var _contextMenu_1 = __importDefault(__webpack_require__(/*! ./_contextMenu */ "./src/scripts/components/_contextMenu.ts"));
...
var tableRow = function tableRow(data, container) {
  ...
  if ((data === null || data === void 0 ? void 0 : data.length) !== 0) {
    ...
    var context = new _contextMenu_1.default();
  } else {
